...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "light_cnn_0203_153447_final"
...
#define AI_NETWORK_IN_1_HEIGHT      (333)
#define AI_NETWORK_IN_1_CHANNEL     (39)
#define AI_NETWORK_IN_1_SIZE        (12987)
#define AI_NETWORK_IN_1_SIZE_BYTES  (51948)
