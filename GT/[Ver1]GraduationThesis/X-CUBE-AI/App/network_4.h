/**
  ...
  ******************************************************************************
  */
#ifndef AI_NETWORK_4_H
#define AI_NETWORK_4_H

#include "network_4_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_4_MODEL_NAME          "network_4"
#define AI_NETWORK_4_ORIGIN_MODEL_NAME   "light_cnn_0406_003729_final_float32"

/******************************************************************************/
#define AI_NETWORK_4_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORK_4_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK_4_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORK_4_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_4_IN \
  ai_network_4_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_4_IN_SIZE { \
  AI_NETWORK_4_IN_1_SIZE, \
}
#define AI_NETWORK_4_IN_SIZE_BYTES { \
  AI_NETWORK_4_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_4_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORK_4_IN_1_HEIGHT      (39)
#define AI_NETWORK_4_IN_1_CHANNEL     (333)
#define AI_NETWORK_4_IN_1_SIZE        (12987)
#define AI_NETWORK_4_IN_1_SIZE_BYTES  (51948)

/******************************************************************************/
#define AI_NETWORK_4_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_4_OUT \
  ai_network_4_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_4_OUT_SIZE { \
  AI_NETWORK_4_OUT_1_SIZE, \
}
#define AI_NETWORK_4_OUT_SIZE_BYTES { \
  AI_NETWORK_4_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_4_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORK_4_OUT_1_CHANNEL     (2)
#define AI_NETWORK_4_OUT_1_SIZE        (2)
#define AI_NETWORK_4_OUT_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_NETWORK_4_N_NODES (26)
 ...
 * @ref ai_network_4_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_4_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_4_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_4_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_4_*
 * defines into file @ref network_4.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_4_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_4_H */
