...
//		0x74, 0x20, 0x10, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x80, 0x7d, 0x00, 0x00, 0x00, 0xf4, 0x01, 0x00,
//		0x04, 0x00, 0x10, 0x00, 0x64, 0x61, 0x74, 0x61, 0x80, 0xa9, 0x03, 0x00};

static uint8_t wav_file_header[44] = {
    0x52, 0x49, 0x46, 0x46,  // "RIFF"
    0x00, 0x00, 0x00, 0x00,  // ChunkSize (update)
    0x57, 0x41, 0x56, 0x45,  // "WAVE"
    0x66, 0x6d, 0x74, 0x20,  // "fmt "
    0x10, 0x00, 0x00, 0x00,  // Subchunk1Size=16
    0x01, 0x00,              // PCM=1
    0x01, 0x00,              // Mono=1
    0xD0, 0x07, 0x00, 0x00,  // fs=2000 (0x07D0)
    0xA0, 0x0F, 0x00, 0x00,  // ByteRate=4000 (2000*2*1)
    0x02, 0x00,              // BlockAlign=2
    0x10, 0x00,              // BitsPerSample=16
    0x64, 0x61, 0x74, 0x61,  // "data"
    0x00, 0x00, 0x00, 0x00   // DataSize (update)
};
