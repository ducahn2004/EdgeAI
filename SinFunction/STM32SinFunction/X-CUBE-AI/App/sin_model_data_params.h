...
#define AI_SIN_MODEL_DATA_ACTIVATIONS_SIZES \
  { 64, }
#define AI_SIN_MODEL_DATA_ACTIVATIONS_SIZE     (64)
#define AI_SIN_MODEL_DATA_ACTIVATIONS_COUNT    (1)
#define AI_SIN_MODEL_DATA_ACTIVATION_1_SIZE    (64)



#define AI_SIN_MODEL_DATA_WEIGHTS_SIZES \
  { 388, }
#define AI_SIN_MODEL_DATA_WEIGHTS_SIZE         (388)
#define AI_SIN_MODEL_DATA_WEIGHTS_COUNT        (1)
#define AI_SIN_MODEL_DATA_WEIGHT_1_SIZE        (388)
