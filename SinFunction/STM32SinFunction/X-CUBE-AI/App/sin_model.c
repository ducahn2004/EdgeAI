...
#define AI_NET_OBJ_INSTANCE g_sin_model
 
#undef AI_SIN_MODEL_MODEL_SIGNATURE
#define AI_SIN_MODEL_MODEL_SIGNATURE     "0x6b3ea63da37aa1c073929ff173c58a29"
...
#define AI_TOOLS_DATE_TIME   "2025-08-03T18:52:44+0700"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_SIN_MODEL_N_BATCHES
#define AI_SIN_MODEL_N_BATCHES         (1)

static ai_ptr g_sin_model_activations_map[1] = AI_C_ARRAY_INIT;
static ai_ptr g_sin_model_weights_map[1] = AI_C_ARRAY_INIT;
...
AI_TENSOR_OBJ_DECLARE(
  ...
  5, 0x0,
  AI_SHAPE_INIT(4, 8, 8, 1, 1), AI_STRIDE_INIT(4, 4, 32, 256, 256),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 388, 1, 1),
    388, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 64, 1, 1),
    64, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_SIN_MODEL_IN_NUM, &serving_default_keras_tensor0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_SIN_MODEL_OUT_NUM, &gemm_4_output),
  &gemm_0_layer, 0x63f69f0e, NULL)
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_SIN_MODEL_MODEL_NAME,
      .model_signature   = AI_SIN_MODEL_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_i32 ai_sin_model_forward(ai_handle network, const ai_buffer* input)
{
